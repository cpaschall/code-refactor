...
**Rafactoring**
Refactoring makes code more accesible and readable, without changinf what the code does.  


HTML

Replaced all "div" tags to the semantic "section" tag
line 11: changed div tag to header tag
line 13: changed div tag to section tag
...
changed unordered list into an ordered list so list items are sequential

CSS
reordered all tags top-down (find correct term) by  precendance

line 11: changed header from class to tag element
changed all header classes into header elements
replaced all "div" tags with "section" tags
replaced class "footer" with element tag "footer"
changed 'ul' elements to 'ol' to apply styling line 35 & 39: changes to ordered list under header tag in index.html
